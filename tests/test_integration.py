...
class TestMainFunction:
    ...
    async def test_main_function_complete_execution(self, capsys):
        ...
        with patch('src.main.get_popular_crypto_symbols') as mock_symbols, \
             patch('src.main.get_top_cryptocurrencies') as mock_cryptos:
...
class TestModuleIntegration:
    ...
    def test_portfolio_analyzer_display_integration(self):
        ...
        from src.modules.portfolio_analyzer import analyze_crypto_portfolio_parallel, display_portfolio_results
...
class TestPerformanceIntegration:
    ...
    async def test_async_performance_timing(self):
        ...
        tasks = [
            monitor_real_exchange_prices('BTC/USDT'),
            monitor_real_exchange_prices('ETH/USDT')
        ]
    ...
    def test_multiprocessing_performance(self):
        ...
        import time
        from src.modules.portfolio_analyzer import analyze_crypto_portfolio_parallel, analyze_crypto_portfolio_sequential
